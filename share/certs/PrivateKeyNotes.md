...
unlocked to sign the Researchcoin-Qt.app bundle.
...
allowing somebody to distribute a Researchcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the researchcoin-qt.exe file inside the installer had not been tampered with.
