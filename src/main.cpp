...
uint256 hashGenesisBlock("0x19922259a7966933eac213db886b2e0978ea5f1328360d39711d5f4f0cddf8b4");
...
const string strMessageMagic = "SocialCoin Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uRSC
...
static const int64 nTargetSpacing = 120; // 1 minutes
...
void ThreadScriptCheck() {
    RenameThread("researchcoin-scriptch");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf3436afc1ea3e0f57aa07ff361c6c3b7586ed939f699be8b96e00d74842ef42b");
    }
...
//        const char* pszTimestamp = " December 19, 2013 — Arrest, strip-search of Indian diplomat in New York triggers uproar.";
        const char* pszTimestamp = "BJ time 26/Oct/2011, Xing & Fu, were born!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
//        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        ...
        block.nVersion = 1;
        block.nTime    = 1404888706;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2930007;

		if (fTestNet)
        {
            block.nTime    = 1404812970;
            block.nNonce   = 2072112;
        }

        //// debug print
        printf("block.GetHash() = %s\n", block.GetHash().ToString().c_str());
        printf("block.hashMerkleRoot = %s\n", block.hashMerkleRoot.ToString().c_str());
        assert(block.hashMerkleRoot == uint256("0xede9f9cbc4c245171e2df1e186456dbc6a9c0bb6f9f5c0529368b9b988d1ae01"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ResearchcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ResearchcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ResearchcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("researchcoin-miner");
    ...
    try { while (true) {
        ...
        printf("Running ResearchcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ResearchcoinMiner terminated\n");
        throw;
    }
}
