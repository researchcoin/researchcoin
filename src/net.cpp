...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("researchcoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Researchcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"eu.hotpoolz.com:8915", "eu.hotpoolz.com:8915"},
    {"us.hotpoolz.com:8915", "us.hotpoolz.com:8915"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Researchcoin is probably already running."), addrBind.ToString().c_str());
        else
